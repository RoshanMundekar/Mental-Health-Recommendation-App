...
import 'package:mentalhealthrecomendation/screens/result_screen.dart';
import 'package:mentalhealthrecomendation/utils/colors.dart';
import 'package:mentalhealthrecomendation/utils/icons.dart';
import 'package:mentalhealthrecomendation/utils/utility_functions.dart';
import 'package:mentalhealthrecomendation/widgets/MyButton.dart';

import '../model/quiz_data.dart';
import '../widgets/variant_item.dart';

class QuizScreen extends StatefulWidget {
  late List<QuizData> quizList;
  late String quizName;

   QuizScreen({Key? key, required this.quizList, required this.quizName})
      : super(key: key);
